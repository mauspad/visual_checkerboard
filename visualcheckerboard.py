...
expName = 'visualcheckerboard'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\mauspad\\Desktop\\line_orientation_scan\\Checkerboard\\visualcheckerboard.py',
...
win = visual.Window(
    ...
    monitor='testMonitor', color=[0.498,0.498,0.498], colorSpace='rgb',
...
text = visual.TextStim(win=win, name='text',
    text='When you see a checkerboard,\nlook at the red dot,\nand try not to let\nyour eyes wander.',
    font='Arial',
    pos=(-250, 0), height=50, wrapWidth=None, ori=0, 
...
image_3 = visual.ImageStim(
    win=win,
    name='image_3', 
    image='images/Checkerboard.jpg', mask=None,
    ori=0, pos=(250, 0), size=(550,450),
...
image_2 = visual.ImageStim(
    win=win,
    name='image_2', 
    image='images/CheckerboardInverse.jpg', mask=None,
    ori=0, pos=(0, 0), size=None,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
...
wait_for_scannerComponents = [text, image_3, key_resp]
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if image_2.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > image_2.tStartRefresh + .25-frameTolerance:
                    # keep track of stop time/frame for later
